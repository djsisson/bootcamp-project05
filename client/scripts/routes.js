...
//check if bookkey is in database
//if key isnt there query openbooks
//call add book and send over info to database
//author can be got from https://openlibrary.org/authors/key
//display book info from database
//this is summary avg rating and number of ratings
